  ...
  return (
    <Page id="contact" flexDir="column" height="fit-content">
      ...
      <RedesDiv>
        ...
        <IconsDiv>
          <a href="https://www.facebook.com/DecaltakOficial/">
            <img src={facebook} />
          </a>
          <a href="https://wa.me/55999777436?text=Nos%20mande%20uma%20mensagem%20e%20assim%20que%20possivel%20vamos%20te%20atender">
            <img src={whats} />
          </a>
          <a href="https://www.instagram.com/decaltakoficial/">
            <img src={instagram} />
          </a>
        </IconsDiv>
      </RedesDiv>
